...
import {CriteriaScoreService} from "@/service/CriteriaScoreService";
      ...
      <div class="card">
        ...
        <DataTable v-if="parentCriteriaId && scores" :first="first" :loading="loading"
          ...
          <template #header>
            ...
            <div class="field grid">
              ...
              <div class="col-12 md:col-10">
                <MultiSelect :filter-fields="['name', 'id']" :modelValue="selectedExpertsShadow" :options="experts" auto-filter-focus
                             class="mr-2" data-key="id" display="chip"
                             filter filter-match-mode="contains"
                             placeholder="Выберите экспертов" style="max-width: 100%;" @before-hide="selectedExperts = selectedExpertsShadow;"
            ...
            <span class="block text-500 font-medium mb-2">Поиск участников</span>
            <div class="field grid">
          ...
          <Column field="participant" frozen>
            <template #header>

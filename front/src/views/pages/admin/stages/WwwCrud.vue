...
import { WwwStageService } from '@/service/admin/stages/WwwStageService';
...
const wwwStageService = new WwwStageService();
...
const loadLazyData = (event) => {
  ...
  wwwStageService.getAll(lazyParams.value).then((data) => {
        ...
        <DataTable
          ...
          <template #header>
            <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
              <h5 class="m-0">Управление участниками Что? Где? Когда?</h5>
